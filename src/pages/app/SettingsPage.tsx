...
function ApiTab() {
  ...
  const demoApiKey = "bl_sk_live_xxxxxxxxxxxxxxxxxxxxxxxxxxxx";
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Use sua chave de API para acessar leads programaticamente via REST API.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <Button size="icon" variant="outline" onClick={() => copyToClipboard(demoApiKey)}>
                <Copy className="h-4 w-4" />
              </Button>
              <Button
                size="icon"
                variant="outline"
                onClick={() => toast.info("Geração de novas chaves estará disponível em breve!")}
              >
          ...
          <div className="space-y-3">
            <h4 className="text-sm font-medium text-foreground">Exemplo de uso</h4>
